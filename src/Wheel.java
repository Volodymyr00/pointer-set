...
public class Wheel {
    ...
    private TypeTyre typeTyre;

    public Wheel(int wheelRadius, TypeTyre typeTyre) {
    ...
    public TypeTyre getTypeTyre() {
        return typeTyre;
    }

    public void setTypeTyre(TypeTyre typeTyre) {
        this.typeTyre = typeTyre;
    }
